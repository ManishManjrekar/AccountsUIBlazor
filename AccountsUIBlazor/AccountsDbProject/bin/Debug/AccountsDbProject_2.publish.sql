...
GO
PRINT N'Creating Default Constraint [dbo].[DF_VendorDetails_createdDate]...';


GO
ALTER TABLE [dbo].[Vendor]
    ADD CONSTRAINT [DF_VendorDetails_createdDate] DEFAULT (getdate()) FOR [CreatedDate];


GO
PRINT N'Creating Default Constraint [dbo].[DF_VendorDetails_modifiedDate]...';


GO
ALTER TABLE [dbo].[Vendor]
    ADD CONSTRAINT [DF_VendorDetails_modifiedDate] DEFAULT (getdate()) FOR [ModifiedDate];
