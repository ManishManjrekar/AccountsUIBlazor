...
GO
PRINT N'Creating Table [dbo].[CustomerBalanceCarryForward]...';


GO
CREATE TABLE [dbo].[CustomerBalanceCarryForward] (
    [CustomerBalanceCarryForwardId] INT            IDENTITY (1, 1) NOT NULL,
    ...
    [IsActive]                      BIT            NULL,
    PRIMARY KEY CLUSTERED ([CustomerBalanceCarryForwardId] ASC)
);
...
CREATE TABLE [dbo].[VendorExpenses] (
    [VendorExpensesId] INT             IDENTITY (1, 1) NOT NULL,
    [VendorId]         INT             NULL,
    [StockInId]        INT             NULL,
    ...
    [modifiedBy]       NVARCHAR (500)  NULL,
    [IsActive]         BIT             NULL,
    PRIMARY KEY CLUSTERED ([VendorExpensesId] ASC)
);
...
GO
PRINT N'Creating Default Constraint [dbo].[DF_CustomerBalanceCarryForward_createdDate]...';


GO
ALTER TABLE [dbo].[CustomerBalanceCarryForward]
    ADD CONSTRAINT [DF_CustomerBalanceCarryForward_createdDate] DEFAULT (getdate()) FOR [CreatedDate];


GO
PRINT N'Creating Default Constraint [dbo].[DF_CustomerBalanceCarryForward_modifiedDate]...';


GO
ALTER TABLE [dbo].[CustomerBalanceCarryForward]
    ADD CONSTRAINT [DF_CustomerBalanceCarryForward_modifiedDate] DEFAULT (getdate()) FOR [ModifiedDate];
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'edf1892f-6c37-425a-8771-efeedd045c03')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('edf1892f-6c37-425a-8771-efeedd045c03')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'e450c7ac-a4bf-4d71-b242-98bd4dc3c9ee')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('e450c7ac-a4bf-4d71-b242-98bd4dc3c9ee')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'd2d2df3a-c756-49b9-a330-ccacdb223cbb')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('d2d2df3a-c756-49b9-a330-ccacdb223cbb')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '2d47558e-46ff-478c-a037-9212f41ff1e6')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('2d47558e-46ff-478c-a037-9212f41ff1e6')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '6debb161-ad9b-4141-bf45-825dbe975196')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('6debb161-ad9b-4141-bf45-825dbe975196')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '1782306f-3855-4fb1-9a8b-714f88209a52')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('1782306f-3855-4fb1-9a8b-714f88209a52')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'e1e514fb-4182-4b5d-8008-728c524dd4e8')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('e1e514fb-4182-4b5d-8008-728c524dd4e8')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '8aaba24a-ba5b-4907-8e45-bb9b7c0da4dc')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('8aaba24a-ba5b-4907-8e45-bb9b7c0da4dc')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '160c92d6-ee61-4ff1-8ff6-0cb25d4f0821')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('160c92d6-ee61-4ff1-8ff6-0cb25d4f0821')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '70f03b0a-675f-4c9f-ac8d-6cadeb3263e5')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('70f03b0a-675f-4c9f-ac8d-6cadeb3263e5')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '07383ec2-dcc3-4979-824f-dbb0b5af239a')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('07383ec2-dcc3-4979-824f-dbb0b5af239a')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'dc0e396d-3a44-4cd2-ace6-7d344503643c')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('dc0e396d-3a44-4cd2-ace6-7d344503643c')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '39c1eabd-2896-4385-baac-893497099f3f')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('39c1eabd-2896-4385-baac-893497099f3f')
